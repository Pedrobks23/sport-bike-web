          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <img src="/assets/Logo.png" alt="Giilberto Bike" className="w-10 h-10" />
                <div>
                  <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Área Administrativa</h1>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Giilberto Bike - Dashboard</p>
                </div>
              </div>
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="mb-12">
            <div className="bg-gradient-to-r from-amber-400 to-amber-600 rounded-2xl p-8 text-white shadow-2xl">
              ...
              <p className="text-xl opacity-90 max-w-2xl">Gerencie todos os aspectos da Giilberto Bike através desta central administrativa moderna e intuitiva.</p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-2 mb-4 md:mb-0">
                ...
                <span className="text-gray-600 dark:text-gray-400">© 2025 Giilberto Bike - Sistema Administrativo</span>
              </div>
