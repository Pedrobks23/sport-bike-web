...
export default function MainNavbar({ isScrolled = false }) {
  ...
  return (
    <>
      <header
        className={`fixed top-0 inset-x-0 z-50 w-full border-b border-white/20 dark:border-white/10 shadow-md supports-[backdrop-filter]:bg-white/30 supports-[backdrop-filter]:dark:bg-neutral-950/30 bg-white/70 dark:bg-neutral-950/60 backdrop-blur-xl backdrop-saturate-150 transition-all duration-300 ${
