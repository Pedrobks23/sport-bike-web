...
async function generateWorkshopTagsPDFMulti(selections) {
  try {
    ...
    selections.forEach((sel, index) => {
      ...
      docPDF.text(`${ordem.codigo} | BIKE`, x + tagWidth / 2, yPos, { align: "center" });
      yPos += 8;

      docPDF.setFontSize(11);
      docPDF.text(
        formatarData(ordem.dataAgendamento),
        x + tagWidth / 2,
        yPos,
        { align: "center" }
      );
    ...
    docPDF.save(`OS-Tags-Oficina.pdf`);
  } catch (err) {
